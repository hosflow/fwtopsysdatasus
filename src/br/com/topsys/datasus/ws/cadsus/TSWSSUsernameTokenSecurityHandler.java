...
public class TSWSSUsernameTokenSecurityHandler implements SOAPHandler<SOAPMessageContext> {

	private String login;
	private String pwd;

	public TSWSSUsernameTokenSecurityHandler(String login, String pwd) {
		this.login = login;
		this.pwd = pwd;
	}
