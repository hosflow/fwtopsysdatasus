...
public class TSPIXClient {
	...
	static {
		...
		// mensagem
		final TSWSSUsernameTokenSecurityHandler handler = new TSWSSUsernameTokenSecurityHandler(
	...
	public static PRPAIN201301UV02 sampleRequest() {
		...
		II idPatient = new II();
		idPatient.setAssigningAuthorityName("CADSUS");
		idPatient.setExtension("9825894104729");
		idPatient.setRoot("2.16.840.1.113883.13.236");
